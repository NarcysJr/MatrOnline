...
<html lang="pt-pt">
    <head>
        ...
        <title>Consultas | Aperfeiçoando O Meu Eu</title>
    </head>
    <body>
        ...
        <div class="col-md-12">
            <div class="row">
                <nav class="navbar-dark fixed col-md-2 mr-auto bg-info" id="menu">
                        <ul class="navbar-nav">
                            <a class="adminbutton nav-link" href="home.php">
                                <i class="fas fa-home fa-3x mt-4"></i>
                                <li class="nav-item">Home</li>
                            </a>
                            <a class="adminbutton nav-link active" href="consultar.php">
                ...
                <section class="col-md-10 col-xs-12 ml-auto" id="conteudo">
                    <div class="row" id="consul">
                        <a class="consultas col-xs-9 col-sm-7 col-md-3 text-light nav-link" id="ver" href="consultar-cursos.php">
                            <i class="fas fa-book-open fa-3x mt-5"></i>
                            <li class="nav-item">Cursos</li>
                        </a>
                        <a class="consultas col-xs-9 col-sm-7 col-md-3 text-light nav-link" id="cadastrar" href="consultar-alunos.php">
                            <i class="fas fa-user fa-3x mt-5"></i>
                            <li class="nav-item">Alunos</li>
                        </a>
                    </div>
                </section>
            </div>
