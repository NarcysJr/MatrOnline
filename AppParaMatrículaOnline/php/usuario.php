            ...
            <div class="row">
                <nav class="navbar-dark fixed col-md-2 bg-info" id="menu">
                        <ul class="navbar-nav">
                            ...
                            <a class="adminbutton nav-link active" href="usuario.php">
                ...
                <section class="col-md-10 col-xs-12 ml-auto" id="conteudo">
                    <div class="row" id="consul">
                        <a class="consultas col-xs-9 col-sm-7 col-md-3  text-light nav-link" id="ver" href="usuario-ver.php">
                            <i class="fas fa-users fa-3x mt-5"></i>
                            <li class="nav-item">Ver</li>
                        </a>
                        <a class="consultas col-xs-9 col-sm-7 col-md-3  text-light nav-link" id="cadastrar" href="usuario-cadastro.php">
